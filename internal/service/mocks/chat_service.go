...
//go:generate minimock -i github.com/passsquale/chat-server/internal/service.ChatService -o chat_service.go -n ChatServiceMock -p mocks
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, c2 model.ChatDTO) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, c2}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, c2 model.ChatDTO)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, c2 model.ChatDTO) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, c2 model.ChatDTO) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &ChatServiceMockCreateParams{ctx, c2},
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, c2 model.ChatDTO) (i1 int64, err error) {
	...
	mm_params := ChatServiceMockCreateParams{ctx, c2}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, c2}
	...
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v", ctx, c2)
	return
}
